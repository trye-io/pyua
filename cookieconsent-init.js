    ...
    languages: {
        'ua': {
            consent_modal: {
                ...
                description: 'Привіт! Крім суто необхідних файлів cookie, цей вебсайт також використовує аналітичні файли cookie. <button type="button" data-cc="c-settings" class="cc-link" aria-haspopup="dialog">Налаштувати</button>',
                primary_btn: {
                    text: 'Погоджуюсь',
            ...
            settings_modal: {
                title: 'Налаштування файлів сookie 🍪',
                ...
                blocks: [
                    {
                        ...
                        description: "З будь-якими питаннями щодо нашої політики файлів cookie, ви можете зв'язатися з нами за наступною <a href='mailto:support@trye.io'> адресою</a>.",
                    }
                ]
            }
        }
